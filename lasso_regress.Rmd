...
k_fold_cv <- function(dataset,
  ...
  fit <- cv.glmnet(X_train %>% as.matrix(), Y_train_num, alpha=alpha)
...
set.seed(100)
a <- Sys.time()
lasso_unordered_df <- k_fold_cv(dataset=dataset3,ordered = FALSE)
Sys.time()-a
# Time difference of 3 hours
# predictors over 1k
write.csv(lasso_unordered_df, file = "results/dataset3_lasso_unordered_df.csv", row.names = FALSE)
```
