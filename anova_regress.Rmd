...
set.seed(100)
a <- Sys.time()
aov_80_unordered_df <- k_fold_cv(dataset=dataset,aov_unordered=10^(-80),ordered = FALSE)
Sys.time()-a
# Time difference of 2.902945 mins
# predictors about 12
# write.csv(aov_80_unordered_df, file = "results/aov_80_unordered_df.csv", row.names = FALSE)
```
